...
- [Setting Up Streaming](#setting-up-streaming)
  - [Using the CLI](#using-the-cli)
    - [Start Streaming at Default Rate (100 Hz)](#start-streaming-at-default-rate-100-hz)
    - [Start Streaming at 50 Hz (20 ms interval)](#start-streaming-at-50-hz-20-ms-interval)
    - [Start Streaming at 10 Hz (100 ms interval)](#start-streaming-at-10-hz-100-ms-interval)
    - [Stop Streaming](#stop-streaming)
  - [Using the REST API](#using-the-rest-api)
    - [Start Streaming at 50 Hz](#start-streaming-at-50-hz)
    - [Stop Streaming](#stop-streaming)
...
- [Common Streaming Rates](#common-streaming-rates)
- [Implementation Examples](#implementation-examples)
- [Troubleshooting](#troubleshooting)
  - [No Data Received](#no-data-received)
  - [Connection Refused](#connection-refused)
  - [Data Rate Too Slow or Fast](#data-rate-too-slow-or-fast)
  - [Invalid or NaN Data](#invalid-or-nan-data)
  - [Connection Drops](#connection-drops)
  - [Buffer Overflow or Latency](#buffer-overflow-or-latency)
- [Performance Considerations](#performance-considerations)
  - [Network Bandwidth](#network-bandwidth)
  - [CPU Load](#cpu-load)
  - [Multiple Clients](#multiple-clients)
- [Data Logging Best Practices](#data-logging-best-practices)
  - [High-Frequency Logging](#high-frequency-logging)
  - [Long-Duration Logging](#long-duration-logging)
  - [Synchronized Multi-Device Logging](#synchronized-multi-device-logging)
- [Advanced Features](#advanced-features)
  - [Selective Data Streaming](#selective-data-streaming)
