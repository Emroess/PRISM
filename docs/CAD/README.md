...
This directory contains all CAD files and 3D models for the **STE-VE** (Simulated Task Exploration | Valve Emulation) project.
...
- *Install the LOWER ADAPTER onto the main STEVE driveshaft using the GoBilda Hyper Hub and 4 M4 screws*
...
- *"*Install the other side of the coupler onto the main STEVE driveshaft*
...
**Assembly Instructions:**
- *The STEVE "REX" drive shaft is an 8mm hex and can be turned with either an 8mm socket and ratchet or a standard 8mm wrench*

- *If desired the Hyper Hub can be raised or lowered to "capture" the wrench.*

---

### [STEVE Device](./STEVE%20Device)
Main device CAD files and assemblies for the complete STE-VE system.
...
- [Main Repository](https://github.com/Emroess/STE-VE)
