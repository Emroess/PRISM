...
base_name = "h-wrench-no-ratchet_eval_reset_complex"
file_ext = ".csv"
...
def complex_eval_reset():
    ...
    client.load_preset(0)  # Load heavy preset
    trial_counter = 0
    ...
    try:
        ...
        while True:
            ...
            def monitor_lever():
                ...
                while monitor_state["running"]:
                    try:
                        ...
                        if curr_pos >= GOAL_ANGLE:
                            print(f"\n     [Goal Achieved] Got to {GOAL_ANGLE} degrees")
            ...
            final_rotation_progress = pos_deg / GOAL_ANGLE # 90 degrees is the max rotation
            
            # Max rotation stats
            max_rotation_deg = monitor_state["max_pos_deg"]
            max_rotation_progress = max_rotation_deg / GOAL_ANGLE
