...
- [DataRecorder Overview](#datarecorder-overview)
  - [Fields Captured](#fields-captured)
- [Basic Recording Workflow](#basic-recording-workflow)
  - [Manual Start/Stop](#manual-startstop)
  - [Context Manager (Auto Stop)](#context-manager-auto-stop)
  - [Timed Recording](#timed-recording)
- [Export Formats](#export-formats)
  - [CSV Export](#csv-export)
  - [JSON Export](#json-export)
  - [HDF5 Export (Large Datasets)](#hdf5-export-large-datasets)
...
- [Visualization](#visualization)
  ...
  - [Post-Recording Plots](#post-recording-plots)
  - [Phase Plot (Velocity vs Position)](#phase-plot-velocity-vs-position)
- [Multi-Session Recording](#multi-session-recording)
  - [Recording Multiple Trials](#recording-multiple-trials)
  - [Automated Test Suite](#automated-test-suite)
- [Advanced Recording](#advanced-recording)
  - [Triggered Recording](#triggered-recording)
  - [Windowed Recording](#windowed-recording)
- [Data Synchronization](#data-synchronization)
  - [Sync with External Events](#sync-with-external-events)
- [Best Practices](#best-practices)
  - [1. Set Appropriate Buffer Size](#1-set-appropriate-buffer-size)
  - [2. Check Disk Space](#2-check-disk-space)
