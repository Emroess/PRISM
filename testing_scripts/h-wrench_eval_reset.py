...
with open("h-wrench_eval_reset.csv", "w", newline="", encoding='utf-8') as file:
...
def simple_eval_reset():
    ...
    try:
        ...
        while True:
            ...
            rotation_progress = pos_deg / 180.0 # 180 degrees is the max rotation
            ...
            with open("h-wrench_eval_reset.csv", "a", newline="", encoding='utf-8') as file:
                writer = csv.writer(file)
