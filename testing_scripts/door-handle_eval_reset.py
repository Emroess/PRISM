...
with open("door-handle_eval_reset.csv", "w", newline="", encoding='utf-8') as file:
        ...
        while True:
            ...
            def monitor_lever():
                ...
                while monitor_state["running"]:
                    ...
                    if not monitor_state["did_move"] and current_deg >= 1.0:
            ...
            pos_deg = max_deg
            rotation_progress = pos_deg / 70 # 70 degrees is the max rotation
            ...
            with open("door-handle_eval_reset.csv", "a", newline="", encoding='utf-8') as file:
                writer = csv.writer(file)
                writer.writerow([i, total_time, time_to_start_turning, total_turning_time, rotation_progress]) 
                i += 1
