...
":root{--bg:#f8fafc;--card:#ffffff;--text:#0f172a;--border:#e2e8f0;--accent:#0f172a;--accent-hover:#334155;--spark-line:#0f172a;--spark-fill:#64748b}"
".dark{--bg:#0f172a;--card:#1e293b;--text:#f8fafc;--border:#334155;--accent:#f8fafc;--accent-hover:#cbd5e1;--spark-line:#f8fafc;--spark-fill:#94a3b8}"
"*{margin:0;padding:0;box-sizing:border-box;transition:background 0.3s,color 0.3s,border-color 0.3s}"
"body{font:14px/1.5 'Inter',system-ui,-apple-system,sans-serif;background:var(--bg);color:var(--text);padding:20px;min-height:100vh}"
...
".metric{background:var(--card);border:1px solid var(--border);border-radius:10px;padding:16px;display:flex;flex-direction:column}"
".metric-label{font-size:12px;color:#64748b;text-transform:uppercase;letter-spacing:0.05em;margin-bottom:8px;font-weight:600}"
".dark .metric-label{color:#94a3b8}"
".metric-value{font:28px 'JetBrains Mono','Courier New',monospace;font-weight:700;margin-bottom:12px}"
".metric-spark{height:45px;width:100%;display:block;margin-top:auto}"
"button,select{font:13px 'Inter',system-ui,sans-serif;padding:8px 16px;background:var(--accent);color:var(--bg);border:none;border-radius:8px;cursor:pointer;font-weight:600;transition:all 0.2s}"
...
".config-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:16px;margin-bottom:20px}"
".config-label{font-size:12px;color:var(--text);margin-bottom:8px;display:block;opacity:0.8;font-weight:500}"
".config-input{font:14px 'JetBrains Mono','Courier New',monospace;width:100%;padding:10px 12px;border:1px solid var(--border);border-radius:8px;background:var(--bg);color:var(--text);transition:border 0.2s}"
...
"</div>"
"<div class=\"card\">"
"<h2 style=\"margin-bottom:20px;font-size:18px;font-weight:600\">System Configuration</h2>"
...
"</div>"
"<div class=\"card\">"
"<h2 style=\"margin-bottom:20px;font-size:18px;font-weight:600\">Manage Presets</h2>"
"<div style=\"margin-bottom:20px\">"
"<label class=\"config-label\">Select Preset to Edit</label>"
"<select class=\"config-input\" id=\"presetSelect\" onchange=\"loadPreset()\" style=\"max-width:300px\"></select>"
"</div>"
"<div class=\"config-grid\">"
...
"<button onclick=\"saveCurrentAsPreset()\" style=\"background:var(--bg);color:var(--text);border:1px solid var(--border)\">Save Current to Preset</button>"
"</div>"
"</div>"
"</div>"
"<script>"
...
"if(localStorage.getItem('theme')==='dark'||(!localStorage.getItem('theme')&&window.matchMedia('(prefers-color-scheme: dark)').matches))document.body.classList.add('dark');"
